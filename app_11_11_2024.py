...
# ===========================================
# Section 1: Signal Analysis (FFT, DFT, STFT)
# ===========================================
...
# ===========================================
# Section 2: Filtering (LPF, HPF, BPF, APF)
# ===========================================
...
def apply_filter():
    ...
    if filter_type == 'lpf':
        ...
        sos = signal.butter(10, 1500 / nyquist, btype='bandstop', output='sos')
...
# ===========================================
# Section 4: Audio Effects (Echo, Pitch, Frequency Shift)
# ===========================================
